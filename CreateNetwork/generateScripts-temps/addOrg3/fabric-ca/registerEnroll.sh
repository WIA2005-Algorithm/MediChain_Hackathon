...
function createOrg3 {
  ...
  set -x
<<<<<<< HEAD:test-network/addOrg3/fabric-ca/registerEnroll.sh
...
=======
  fabric-ca-client enroll -u https://CAsura:CAsurapw@localhost:11054 --caname ca-org3 --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
>>>>>>> 679ad6f... First commit:CreateNetwork/generateScripts-temps/addOrg3/fabric-ca/registerEnroll.sh
  { set +x; } 2>/dev/null
...
=======
  fabric-ca-client register --caname ca-org3 --id.name CAsuraadmin --id.secret CAsuraadminpw --id.type admin --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
>>>>>>> 679ad6f... First commit:CreateNetwork/generateScripts-temps/addOrg3/fabric-ca/registerEnroll.sh
  { set +x; } 2>/dev/null
...
=======
	fabric-ca-client enroll -u https://CAsuraadmin:CAsuraadminpw@localhost:11054 --caname ca-org3 -M ${PWD}/../organizations/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
>>>>>>> 679ad6f... First commit:CreateNetwork/generateScripts-temps/addOrg3/fabric-ca/registerEnroll.sh
  { set +x; } 2>/dev/null
