...
//--------------------- GENERIC ERRORS -------------------------/
errors.invalid_host = new ApiError(
  401,
  "UNKNOWN HOST ORGANIZATION",
  "The request could not be completed due to the missing requirements"
);
errors.duplicate_identity = new ApiError(
  409,
  "DUPLICATE IDENTITY",
  "The request could not be completed due to a conflict with the current state of the resource"
);
errors.required_admin = new ApiError(
  401,
  "ADMIN ENROLLMENT REQUIRED",
  "The request could not be completed due to the missing requirements"
);
errors.file_not_found = new ApiError(
  500,
  "INTERNAL SERVER ERROR",
  "If you are the developer, please check your server logs for more information"
);
errors.execution_failed = new ApiError(
  500,
  "SCRIPT EXECUTION ERROR",
  "The request for creating network has failed"
);
errors.network_not_found = new ApiError(
  400,
  "PROPERTY REQUESTED NOT FOUND",
  "The requested blockchain network doesn't exists"
);
errors.maximum_organizations_reached = new ApiError(
  409,
  "MAXIMUM LIMIT REACHED",
  "The number of organizations are reached"
);
errors.request_failed = new ApiError(
  500,
  "FAILED TO FULFIL REQUEST",
  "There was an error while fulfilling the request. Try again later"
);
...
errors.not_reachable = new ApiError(
  500,
...
errors.identity_not_found = new ApiError(
  401,
  "Unknown User",
  "Make sure to login/Signup before submitting requests"
);
errors.signUpError = new ApiError(
  500,
  "Unknown Error",
