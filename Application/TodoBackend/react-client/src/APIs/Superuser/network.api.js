...
export const updateToken = (token) => {
  ...
  return axios.post("/update-token", {
    refreshToken: token
  });
};
...
export const deleteOrganization = (networkName, org, admin) =>
  axios.delete(`/superuser/organizations/${networkName}/${org}/${admin}`);

export const enrollAdmin = (orgName) =>
  axios.post(`/superuser/organizations/${orgName}/enroll`);
