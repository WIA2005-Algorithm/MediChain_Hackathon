        ...
        <Box sx={{ padding: "8px 16px" }}>
            ...
            >
                ...
                <Autocomplete
                    ...
                    options={
                        country ? CountryCity.getStatesByShort(country) : []
                    }
                    autoHighlight
                    sx={{ ml: 1 }}
...
export default function FullScreenDialog({ broadcastAlert }) {
    const navigate = useNavigate();
    const { networkName } = useParams();
    const handleClose = (org = undefined) => {
        if (org)
            broadcastAlert((prev) => [
                ...prev,
                getAlertValues(
                    "info",
                    "New Hospital Organization Created",
                    `We have successfully added a new hospital organization - ${org}`
                ),
            ]);
    ...
    const handleSubmit = (event) => {
        ...
        createOrganization(
            ...
            .then(() => {
                // Also present a success message
                handleClose(data.get("orgID").trim());
            })
            .catch((e) => {
                e.response.data.DETAILS
                    ? setFormResponseAlert(e.response.data.DETAILS)
                ...
                >
                    <Typography component="span" variant="h6">
                        ...
                        <Typography sx={{ color: "text.secondary" }}>
                            <small>
                                There are 2 parts of this form listed below.
                                Both are required.
                            </small>
                        </Typography>
                    </Typography>
                    ...
                    >
                        <ListItemButton
                            ...
                            sx={{
                                ...
                                alignItems: "center",
                                borderRadius: `${
                                    openOrgDetails ? "12px 12px 0 0" : "12px"
                                }`,
                            }}
                        ...
                        >
                            <Typography component="small">
                                ...
                                <Typography sx={{ color: "text.secondary" }}>
                                    <small>
                                        The hospital organization details helps
                                        determine and create the Certification
                                        Authority (CA) for it's particular
                        ...
                        <ListItemButton
                            ...
                            sx={{
                                ...
                                alignItems: "center",
                                borderRadius: `${
                                    openAdminDetails ? "12px 12px 0 0" : "12px"
                                }`,
                            }}
                            onClick={() =>
                                setOpenAdminDetails(!openAdminDetails)
                            }
                        >
                            <Typography component="small">
                                ...
                                <Typography sx={{ color: "text.secondary" }}>
                                    <small>
                                        The hospital location details helps
                                        determine the valid permission control
                                        over the records for it's particular
                                        doctors and patients while exchangin
