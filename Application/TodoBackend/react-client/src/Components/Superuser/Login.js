      ...
      <Container component="main" maxWidth="xs">
        ...
        <Logo/>
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ mt: 1 }}>
              ...
              InputProps={{
                ...
                endAdornment: (
                        <InputAdornment position="end">
                           <IconButton onClick={()=> changeVisibility()} sx={{color: 'text.primary'}}>
                           <GetVisibility/>
                           </IconButton>
                        </InputAdornment>
                )
            ...
            {error && 
            <Collapse in={open} onExited={() => {setError(undefined);}}><Alert severity="error" sx={{fontSize: '13px', mb: 2}}  
            action={
            <IconButton
              aria-label="close"
              color="inherit"
          ...
          }><b>{error}</b></Alert></Collapse>}
            <Grid container textAlign='center' fontSize='13px' color='text.secondary'>
            Please contact the blockchain developer, if you have forgotten your superuser password
            </Grid>
          </Box>
        </Box>
        </SectionContainer>
