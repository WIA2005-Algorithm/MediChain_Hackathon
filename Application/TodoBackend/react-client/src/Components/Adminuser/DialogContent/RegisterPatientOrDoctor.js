...
import { getAlertValues, Transition } from "../../StyledComponents";
import {
    Alert,
    Autocomplete,
    Collapse,
    ...
    return (
        <Box sx={{ padding: "8px 16px" }}>
            <TextField
                ...
                onChange={(e) =>
                    setField("street1", String(e.target.value).trim())
                }
                InputProps={{
                    startAdornment: (
            ...
            <TextField
                ...
                id="street2"
                onChange={(e) =>
                    setField("street2", String(e.target.value).trim())
                }
            ...
            >
                <TextField
                    ...
                    type="number"
                    onChange={(e) =>
                        setField("postcode", String(e.target.value).trim())
                    }
                    id="postcode"
            ...
            >
                ...
                <TextField
                    ...
                    onChange={(e) =>
                        setField("city", String(e.target.value).trim())
                    }
                    autoComplete="off"
...
function PersonalDetails({ personalDetails, setTheField, setRequiredError }) {
        ...
        <Box sx={{ padding: "8px 16px" }}>
            ...
            >
                <TextField
                    ...
                    sx={{ mr: 1 }}
                    onChange={(e) =>
                        setField("firstName", String(e.target.value).trim())
                    }
                    InputProps={{
                        startAdornment: (
                            <InputAdornment position="start">
                ...
                <TextField
                    ...
                    onChange={(e) =>
                        setField("middleName", String(e.target.value).trim())
                    }
                    InputProps={{
                        startAdornment: (
                            <InputAdornment position="start">
                ...
                <TextField
                    ...
                    sx={{ mr: 1 }}
                    onChange={(e) =>
                        setField("lastName", String(e.target.value).trim())
                    }
                    InputProps={{
                        startAdornment: (
                            <InputAdornment position="start">
            ...
            >
                ...
                >
                    ...
                    <Select
                        ...
                        label="Gender"
                        onChange={(newM) =>
                            setField("gender", newM.target.value)
                        }
                    >
                        <MenuItem value="">
                            <em>Please Select</em>
                    ...
                    <FormHelperText>
                        Please key in your gender for the record
                    </FormHelperText>
                </FormControl>
                <FormControl
                    sx={{
                ...
                >
                    <InputLabel id="marital-status-helper">
                        Marital Status
                    </InputLabel>
                    <Select
                        labelId="marital-status-helper"
                        ...
                        onChange={(newM) =>
                            setField("maritalStatus", newM.target.value)
                        }
                    >
                        <MenuItem value="">
                            <em>Please Select</em>
        ...
        <Box sx={{ padding: "8px 16px" }}>
            ...
            >
                <TextField
                    ...
                    sx={{ mr: 1 }}
                    onChange={(e) =>
                        setField("mobile", String(e.target.value).trim())
                    }
                    InputProps={{
                        startAdornment: (
                            <InputAdornment position="start">
                ...
                <TextField
                    ...
                    sx={{ mr: 1 }}
                    onChange={(e) =>
                        setField("whatsapp", String(e.target.value).trim())
                    }
                    InputProps={{
                        startAdornment: (
                            <InputAdornment position="start">
            ...
            <Collapse in={otherNoActive} timeout="auto">
                <TextField
                    ...
                    sx={{ mr: 1 }}
                    onChange={(e) =>
                        setField("other", String(e.target.value).trim())
                    }
                    InputProps={{
                        startAdornment: (
                            <InputAdornment position="start">
        ...
        <Box sx={{ padding: "8px 16px" }}>
            ...
            >
                <TextField
                    ...
                    sx={{ mr: 1 }}
                    onChange={(e) =>
                        setField("ID", String(e.target.value).trim())
                    }
                    InputProps={{
                        startAdornment: (
                            <InputAdornment position="start">
                ...
                <TextField
                    ...
                    helperText={`${
                        user
                            ? "This alternate key acts as first time login for patient."
                            : ""
                    ...
                    sx={{ ml: 1 }}
                    onChange={(e) =>
                        setField("password", String(e.target.value).trim())
                    }
                    InputProps={{
                        startAdornment: (
                            <InputAdornment position="start">
            ...
            {!user && (
                ...
                >
                    ...
                    <FormHelperText>
                        Please key in your the hospital you want to register for
                        the record. If you are unable to find your hospital,
...
export default function RegisterPatient({ broadcastAlert, user }) {
        ...
        switch (type) {
            ...
            case "personalDetails":
                ...
                for (const [key, _] of Object.entries(
                    personalDetails.setRequiredError
                ))
                    if (key === field) {
    ...
    const closeForError = (message) => {
        if (message)
            setFormResponseAlert((prev) => `${message} - ${prev || ""}`);
        setTimeout(() => {
            setLoading(false);
            setOpen(true);
        }, 200);
    ...
    const handleClose = (url) => {
        if (url && user.org)
            broadcastAlert((prev) => [
                ...
                getAlertValues(
                    "info",
                    "New Patient was enrolled successfully",
    ...
    const handleSubmit = (event) => {
        ...
        if (error) {
            closeForError(
                `An error has occured in "Sign Up Details" Section as follows`
            );
            return;
        }
        ...
        if (error) {
            closeForError(
                `An error has occured in "Personal Details" Section as follows`
            );
            return;
        }
        ...
        if (!/^[\w'\-,.][^0-9_!¡?÷?¿/\\+=@#$%ˆ&*(){}|~<>;:[\]]{2,}$/.test(val))
            error = handleValidationError(
                "City Name entered is invalid",
                city,
                setAddress
            );
        if (error) {
            closeForError(
                `An error has occured in "Address Details" Section as follows`
            );
            return;
        }
                ...
                >
                    <Typography component="span" variant="h6">
                        ...
                        <Typography sx={{ color: "text.secondary" }}>
                            <small>
                                <em>
                                    All four parts of the form are required to
                                    create the account
                                </em>
                            </small>
                        </Typography>
                    ...
                    >
                        ...
                        >
                            <Typography component="small">
                                ...
                                <Typography sx={{ color: "text.secondary" }}>
                                    <small>
                                        The below details will serve as the
                                        login details for the account. Passport
                                        Number is the userID
                                    </small>
                                </Typography>
                            </Typography>
                            <ExpandCircleDown
                                sx={{
                                    transform: `rotate(${
                                        loginDetails.fields.active ? 180 : 0
                                    }deg)`,
                        ...
                        <Collapse
                            in={loginDetails.fields.active}
                            timeout="auto"
                        >
                            <LoginDetails
                                user={user}
                                loginDetails={loginDetails.fields.active}
                        ...
                        >
                            <Typography component="small">
                                ...
                                <Typography sx={{ color: "text.secondary" }}>
                                    <small>
                                        Personal Details are required to create
                                        new patient account. These details are
                            ...
                            <ExpandCircleDown
                                sx={{
                                    transform: `rotate(${
                                        personalDetails.fields.active ? 180 : 0
                                    }deg)`,
                                    transition: "ease-in 0.2s",
                                }}
                            />
                        ...
                        <Collapse
                            in={personalDetails.fields.active}
                            timeout="auto"
                        >
                            <PersonalDetails
                        ...
                        >
                            <Typography component="small">
                                ...
                                <Typography sx={{ color: "text.secondary" }}>
                                    <small>
                                        The location details are required for
                                        the hospital for the benefit of the
                                        patient
                                    </small>
                                </Typography>
                            </Typography>
                        ...
                        >
                            <Typography component="small">
                                ...
                                <Typography sx={{ color: "text.secondary" }}>
                                    <small>
                                        The contact details are important for
                                        the hospital to contact{" "}
                                        {user && "the patient"} {!user && "you"}{" "}
                                        for further process, if any
                                    </small>
                                </Typography>
                            </Typography>
                            <ExpandCircleDown
                                sx={{
                                    transform: `rotate(${
                                        contactDetails.fields.active ? 180 : 0
                                    }deg)`,
                                    transition: "ease-in 0.2s",
                                }}
                            />
                        ...
                        <Collapse
                            in={contactDetails.fields.active}
                            timeout="auto"
                        >
