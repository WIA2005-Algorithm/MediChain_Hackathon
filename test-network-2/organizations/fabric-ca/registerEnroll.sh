...
function createOrg1() {
  ...
  set -x
<<<<<<< HEAD:test-network/organizations/fabric-ca/registerEnroll.sh
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7054 --caname ca-org1 --tls.certfiles "${PWD}/organizations/fabric-ca/org1/tls-cert.pem"
=======
  fabric-ca-client enroll -u https://Admin:Adminpw@localhost:7054 --caname ca-org1 --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
>>>>>>> 679ad6f... First commit:test-network-2/organizations/fabric-ca/registerEnroll.sh
  { set +x; } 2>/dev/null
...
=======
  fabric-ca-client register --caname ca-org1 --id.name Adminadmin --id.secret Adminpwadminpw --id.type admin --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
>>>>>>> 679ad6f... First commit:test-network-2/organizations/fabric-ca/registerEnroll.sh
  { set +x; } 2>/dev/null
...
=======
  fabric-ca-client enroll -u https://Adminadmin:Adminpwadminpw@localhost:7054 --caname ca-org1 -M ${PWD}/organizations/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org1/tls-cert.pem
>>>>>>> 679ad6f... First commit:test-network-2/organizations/fabric-ca/registerEnroll.sh
  { set +x; } 2>/dev/null
...
=======
  fabric-ca-client register --caname ca-org2 --id.name Adminadmin --id.secret Adminpwadminpw --id.type admin --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
>>>>>>> 679ad6f... First commit:test-network-2/organizations/fabric-ca/registerEnroll.sh
  { set +x; } 2>/dev/null
...
=======
  fabric-ca-client enroll -u https://Adminadmin:Adminpwadminpw@localhost:8054 --caname ca-org2 -M ${PWD}/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org2/tls-cert.pem
>>>>>>> 679ad6f... First commit:test-network-2/organizations/fabric-ca/registerEnroll.sh
  { set +x; } 2>/dev/null
